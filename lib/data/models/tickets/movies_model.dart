...
List<MovieModel> usMovieServices = [
  ...
  MovieModel(
    ...
    showtimes: ['10:00 AM', '1:30 PM', '4:45 PM', '7:15 PM', '10:30 PM'],
    ticketPrice: 14.99,
    posterUrl: '',
  ),
  ...
  MovieModel(
    ...
    cast: ['Melissa Barrera', 'Jenna Ortega', 'Jasmin Savoy Brown', 'Mason Gooding'],
    director: 'Matt Bettinelli-Olpin',
    cinemaChain: 'Cinemark Theatres',
    showtimes: ['2:00 PM', '5:30 PM', '8:45 PM', '11:15 PM'],
    ticketPrice: 12.75,
    posterUrl: '',
  ),
  ...
  MovieModel(
    ...
    cast: ['Harrison Ford', 'Phoebe Waller-Bridge', 'Antonio Banderas', 'Karen Allen'],
  ...
  MovieModel(
    ...
    showtimes: ['11:00 AM', '3:15 PM', '7:30 PM'],
    ticketPrice: 16.50,
    posterUrl: '',
  ),
  ...
  MovieModel(
    ...
    showtimes: ['12:45 PM', '4:15 PM', '7:45 PM'],
    ticketPrice: 15.75,
    posterUrl: '',
  ),
  ...
  MovieModel(
    ...
    cast: ['Jim Caviezel', 'Mira Sorvino', 'Bill Camp', 'Kurt Fuller'],
  ...
  MovieModel(
    ...
    cast: ['Lana Condor', 'Toni Collette', 'Annie Murphy', 'Sam Richardson'],
