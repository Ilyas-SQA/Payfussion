...
class BusModel {
  ...
  BusModel({
    ...
    this.totalSeats = 50,
    this.departurePoints = const [],
    this.arrivalPoints = const [],
  });
  ...
  factory BusModel.fromMap(Map<String, dynamic> map) {
    return BusModel(
      ...
      departurePoints: List<String>.from(map['departurePoints'] ?? []),
      arrivalPoints: List<String>.from(map['arrivalPoints'] ?? []),
    );
  }
}
...
List<BusModel> usBusServices = [
  ...
  BusModel(
    ...
    amenities: ['Free WiFi', 'Power Outlets', 'Restroom', 'Reclining Seats', 'Luggage Storage'],
    busType: 'Express',
    totalSeats: 55,
    departurePoints: ['Port Authority Bus Terminal, NYC'],
    arrivalPoints: ['Los Angeles Union Station'],
  ),
  ...
  BusModel(
    ...
    amenities: ['Free WiFi', 'Power Outlets', 'Restroom', 'Air Conditioning'],
    busType: 'Express',
    totalSeats: 55,
  ),
  ...
  BusModel(
    ...
    amenities: ['Free WiFi', 'Power Outlets', 'Extra Legroom', 'Panoramic Windows', 'Snack Bar'],
    busType: 'Premium',
    totalSeats: 49,
  ),
  ...
  BusModel(
    ...
    amenities: ['Free WiFi', 'Power Outlets', 'Restroom', 'Upper Deck Views'],
    busType: 'Economy',
  ...
  BusModel(
    ...
    amenities: ['Free WiFi', 'Power Outlets', 'Restroom'],
    busType: 'Economy',
    totalSeats: 55,
  ),
  ...
  BusModel(
    ...
    amenities: ['Free WiFi', 'Power Outlets', 'Reserved Seating', 'Express Service'],
    busType: 'Express',
    totalSeats: 48,
  ),
  ...
  BusModel(
    ...
    amenities: ['Free WiFi', 'Power Outlets', 'Restroom', 'Reclining Seats'],
    busType: 'Premium',
    totalSeats: 50,
  ),
  ...
  BusModel(
    ...
    amenities: ['Free WiFi', 'Power Outlets', 'Restroom', 'Mountain Views'],
    busType: 'Express',
    totalSeats: 52,
  ),
  ...
  BusModel(
    ...
    amenities: ['Free WiFi', 'Power Outlets', 'Restroom', 'Comfortable Seating'],
    busType: 'Economy',
    totalSeats: 55,
  ),
  ...
  BusModel(
    ...
    amenities: ['Free WiFi', 'Power Outlets', 'Leather Seats', 'Personal Entertainment', 'Restroom'],
    busType: 'Premium',
  ...
  BusModel(
    ...
    amenities: ['Free WiFi', 'Power Outlets', 'Restroom', 'Spacious Seats'],
    busType: 'Premium',
    totalSeats: 50,
  ),
  ...
  BusModel(
    ...
    amenities: ['Free WiFi', 'Power Outlets', 'Air Conditioning', 'Restroom'],
    busType: 'Economy',
    totalSeats: 55,
  ),
  ...
  BusModel(
    ...
    amenities: ['Free WiFi', 'Power Outlets', 'Restroom', 'Package Express'],
    busType: 'Economy',
    totalSeats: 47,
  ),
  ...
  BusModel(
    ...
    amenities: ['Free WiFi', 'Power Outlets', 'Restroom', 'Bilingual Service'],
    busType: 'Economy',
    totalSeats: 55,
  ),
  ...
  BusModel(
    ...
    amenities: ['Free WiFi', 'Power Outlets', 'Restroom', 'Lake Views'],
    busType: 'Economy',
    totalSeats: 50,
  ),
  ...
  BusModel(
    ...
    amenities: ['Free WiFi', 'Power Outlets', 'Restroom', 'USB Charging'],
    busType: 'Premium',
    totalSeats: 50,
  ),
  ...
  BusModel(
    ...
    amenities: ['Free WiFi', 'Power Outlets', 'Restroom', 'GPS Tracking', 'Mobile App'],
    busType: 'Premium',
    totalSeats: 52,
  ),
  ...
  BusModel(
    ...
    amenities: ['Free WiFi', 'Power Outlets', 'Restroom', 'Reserved Seating'],
    busType: 'Express',
    totalSeats: 48,
  ),
