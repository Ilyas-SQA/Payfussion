...
class PostpaidBillSummaryScreen extends StatelessWidget {
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                // Features Card
                _buildFeaturesCard(context, state.features),
                SizedBox(height: 16.h),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Row(
            children: <Widget>[
              Icon(Icons.featured_play_list, color: MyTheme.primaryColor, size: 24.sp),
              SizedBox(width: 12.w),
              Text(
                'Plan Features',
                style: TextStyle(
  ...
  Widget _buildAmountCard(BuildContext context, PostpaidBillDataSet state) {
    return Container(
      ...
      child: Column(
        children: <Widget>[
          _buildAmountRow('Bill Amount', '\$${state.amount.toStringAsFixed(2)}', isWhite: true),
